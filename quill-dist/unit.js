...
var Quill = function () {
  ...
  function Quill(container) {
    ...
    this.selection = new _selection2.default(this.scroll, this.emitter, this.document);
...
var Selection = function () {
  function Selection(scroll, emitter, document) {
    var _this = this;
    ...
    this.emitter.listenDOM('selectionchange', this.document, function () {
      if (!_this.mouseDown) {
  ...
  _createClass(Selection, [{
    ...
    value: function handleDragging() {
      ...
      this.emitter.listenDOM('mousedown', this.document.body, function () {
        _this3.mouseDown = true;
      });
      // this.emitter.listenDOM('mouseup', document.body, () => {
      this.emitter.listenDOM('mouseup', this.document.body, function () {
...
var _quill = __webpack_require__(76);
